...
sub EVENT_SAY {
 ...
 if(($text=~/interested/i) && ((plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
    ...
    if(($text=~/interested/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")))) {
    ...
    if(($text=~/interested/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")) || (plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
 ...
 if (($text=~/what work/i) && ((plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
   quest::say("Wonderful. Return to the plane and continue your studies of the hybrid demons. With the new information you have brought I believe we have a good framework of reference for the lower rankings of these beings, however there is a higher echelon of power that I will need to be familiar with. Seek out the Teir`Dal knights and grave lords of hate. All of these creatures should be within your area of study, but take care! Make sure to keep your protection with you at all times. Some of them should have a kind of Knight's crest symbolizing their rank; bring me this crest and some ghast fingerbones, along with your Gem of Courage. If you succeed in this task you are more valuable than I could have imagined, and I may need your skill with a final reconnaissance errand.");
    ...
    if (($text=~/what work/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")))) {
    ...
    if (($text=~/what work/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")) || (plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
     quest::say("Please speak to my sister, Seana, for further information. She will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
 }
 if (($text=~/what final task/i) && ((plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
   quest::say("In my personal studies I have heard rumor that there are four archaic tomes that contain some of Innoruuk's darkest secrets. I cannot ask you to uncover all four, I am not even certain that they exist. The fabled tomes are the Compendium of Classic Torture, Texts on Pain, Writ of Agony, and Tactical Hatred. If they do indeed exist and you manage to find them, you are far grander than I. The tome that I do seek will most likely lie in the hands of one of Innoruuk's own confidantes, and they seldom seem to show their faces. It is possible the Prince of Hate himself holds the tomes close. Find me the Compendium of Classic Torture; return it to me with your Gem of Daring and your work is finished.");
    ...
    if (($text=~/what final task/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")))) {
    ...
    if (($text=~/what final task/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")) || (plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
     quest::say("Please speak to my sister, Seana, for further information. She will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
 }
}
