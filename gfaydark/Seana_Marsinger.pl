...
sub EVENT_SAY {
 ...
 if(($text=~/interested/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")) || (plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
   ...
   if(($text=~/interested/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")))) {
   ...
   if(($text=~/interested/i) && ((plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
 ...
 if(($text=~/work/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")) || (plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
   quest::say("Please speak to my brother, Stefan, for further information. He will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
 }
  if(($text=~/work/i) && ((plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
   ...
   if(($text=~/work/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")))) {
 ...
 if(($text=~/final task/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")) || (plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
   quest::say("Please speak to my brother, Stefan, for further information. He will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
 }
   if(($text=~/final task/i) && ((plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
   ...
   if(($text=~/final task/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")))) {
